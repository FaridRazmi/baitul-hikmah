...
if (borrower) {
  document.getElementById("borrowerInfo").innerHTML = `
    <div class="info-section">
      ...
      <div class="info-row"><span class="info-label">Return Date</span><span class="info-value">${borrower.dateReturn}</span></div>
    </div>`;
} else {
  document.getElementById("borrowerInfo").innerHTML = `
    <div class="info-section">
 ...
 *Date*      : ${borrower.date}
 *Date to return *      : ${borrower.dateReturn}
